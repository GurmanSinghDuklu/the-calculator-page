      ...
      <div className="bg-dark-bg text-dark-text min-h-screen font-sans selection:bg-green-500/30">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-6">
          <nav className="flex items-center gap-2 font-heading text-[10px] uppercase tracking-widest text-white/30">
            ...
            <span>/</span>
            <span className="text-white/60">Temperature Converter</span>
          </nav>
        </div>
        ...
        <div className="flex flex-col lg:flex-row min-h-[90vh] max-w-7xl mx-auto px-6 py-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col z-10 lg:w-1/2 select-none">
            ...
            <h1 className="sr-only">Temperature Converter</h1>
            <div aria-hidden="true" className="font-display leading-[0.85] tracking-tighter">
              <span className="block text-[9vw] lg:text-[72px]" style={{
            ...
            <div className="mt-8 max-w-sm pl-4 border-l-2" style={{ borderColor: `${ACCENT}60` }}>
              <p className="text-gray-400 text-base leading-relaxed font-sans font-light">
                Convert between Celsius, Fahrenheit, and Kelvin — instantly and accurately.
              </p>
            </div>
