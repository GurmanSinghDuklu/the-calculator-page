...
const faqs = [
  { question: "What is an ISA and how does it work?", answer: "An ISA (Individual Savings Account) is a UK tax wrapper that shelters savings or investments from income tax and capital gains tax. In 2026/27, you can deposit up to £20,000 per year across all ISA types. Any interest, dividends, or investment gains made inside an ISA are completely tax-free — now and in the future, even when you withdraw." },
