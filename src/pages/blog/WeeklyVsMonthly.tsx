...
const WeeklyVsMonthly = () => {
  return (
    <>
      <SEO
        title="You're Losing $147,000 by Investing Monthly Instead of Weekly | The Calculator Page"
        ...
        canonicalUrl="https://www.thecalculatorpage.com/blog/weekly-vs-monthly-investing"
      />
