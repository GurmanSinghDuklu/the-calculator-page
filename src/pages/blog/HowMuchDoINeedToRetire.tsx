  ...
  return (
    <>
      ...
      <BlogLayout
        ...
        directAnswer="To fund a moderate retirement of £31,300 per year in the UK, you need approximately £470,000 in pension savings alongside the full State Pension of £12,547 per year. Using the 4% withdrawal rule: £18,753 needed from investments ÷ 0.04 = £468,825. For a comfortable retirement at £43,100 per year, the required pot rises to approximately £765,000 with the State Pension offset."
      ...
      >
        ...
        <h2>The three UK retirement standards (2026)</h2>
        ...
        <p>Most people target something between moderate and comfortable. The State Pension covers £12,547 of this — so your personal pension needs to bridge the gap.</p>
        ...
        <ul>
          <li>Subtract State Pension: £31,300 − £12,547 = £18,753 needed from your pot</li>
          <li>Required pot: £18,753 ÷ 0.04 = <strong>£468,825</strong></li>
        </ul>

        <p><strong>Comfortable retirement target: £43,100/year</strong></p>
        <ul>
          <li>Subtract State Pension: £43,100 − £12,547 = £30,553 needed from pot</li>
          <li>Required pot: £30,553 ÷ 0.04 = <strong>£763,825</strong></li>
        </ul>
        ...
        <p>The full new State Pension in 2026/27 is <strong>£241.30/week (£12,547/year)</strong>. You need 35 qualifying years of National Insurance contributions. Check your NI record via the government's online service — if you have gaps, voluntary Class 3 contributions fill them, and each year bought adds roughly £358/year in State Pension for life. That's typically a very strong return.</p>
