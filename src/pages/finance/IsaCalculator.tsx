    ...
    <>
      ...
      <div className="bg-dark-bg text-dark-text min-h-screen font-sans selection:bg-green-500/30">
          ...
          <div className="w-full lg:w-1/2 z-20 relative">
            ...
            <div className="bg-[#252323]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="space-y-5">
                ...
                {/* Calculate button */}
                <button
                  onClick={() => onCalculate(calculateIsa)}
        ...
        <div className="max-w-5xl mx-auto px-6 pb-6">
          <p className="text-zinc-500 text-xs">Further reading: <Link to="/learn/compound-interest-formula" className="text-blue-400 hover:text-blue-300 underline transition-colors">The Compound Interest Formula: Complete Guide — Crypto, DCA, Inflation & More</Link></p>
        </div>
